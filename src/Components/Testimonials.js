        ...
        >
          <MDBCarouselInner>
            <MDBCarouselItem itemId="1">
              <p>
                <MDBIcon icon="quote-left" className="green-text" /> Great
                organization, quick appointments.
              </p>
            ...
            <MDBCarouselItem itemId="2">
              <p>
                <MDBIcon icon="quote-left" className="green-text" /> Simply put
                ... Great team, great Site!!! I promise you won't be
                disappointed. One can only praise without end!
              </p>
            ...
            <MDBCarouselItem itemId="3">
              <p>
                <MDBIcon icon="quote-left" className="green-text" /> I am very
                pleased! Mobile Health is technically very competent and also
                top-notch personally!
              </p>
